Portfolio OS is a lightweight macOS menu bar app that automatically switches your wallpaper when you toggle between light and dark mode. Set it once and forget it — AutoWallX runs silently in the background and keeps your desktop looking perfect in any appearance.
